...
- replace(): Multiple variations for replacing substrings - O(N)
  ...
  - replace(pos, len, str, subpos, sublen): Replaces the substring of length len starting from pos with substring of length sublen starting from subpos of str
...
int main()
{
	...
	*/
	...
	ch_ptr++;					   // Works fine
	cout << *(--ch_ptr) << endl;   // Works fine
	cout << *(ch_ptr + 2) << endl; // Same as ch_ptr[2]
	...
	*/
	cout << sizeof(S) << endl; // Will probably print more than 21
	...
	cout << "After erase(5, 2): " << erase_str << endl;

	erase_str.erase(5); // Removes everything after index 5
	cout << "After erase(5): " << erase_str << endl;

	erase_str = "Hello, World!";
	erase_str.erase(erase_str.begin() + 7); // Removes 'W'
	cout << "After erase(begin()+7): " << erase_str << endl;

	erase_str.erase(erase_str.begin() + 2, erase_str.begin() + 5);
	cout << "After erase range: " << erase_str << endl;

	// Swap Example
	cout << "---------------------------------------------------------------------------------" << endl;
	string swap1 = "First", swap2 = "Second";
	swap1.swap(swap2);
	cout << "After swap: swap1 = " << swap1 << ", swap2 = " << swap2 << endl;

	// Find Examples
	cout << "---------------------------------------------------------------------------------" << endl;
	string find_str = "This is a simple example.";
	cout << "Find 'simple': " << find_str.find("simple") << endl;
	cout << "Find 'is' after index 3: " << find_str.find("is", 3) << endl;
	cout << "Find first occurrence of 's': " << find_str.find('s') << endl;
	cout << "Find first 3 characters of 'example': " << find_str.find("example", 0, 3) << endl;

	// Reverse Find Examples
	cout << "---------------------------------------------------------------------------------" << endl;
	cout << "Reverse Find 'simple': " << find_str.rfind("simple") << endl;
	cout << "Reverse Find 'is' before index 10: " << find_str.rfind("is", 10) << endl;
	cout << "Reverse Find 's': " << find_str.rfind('s') << endl;
	cout << "Reverse Find first 3 characters of 'example': " << find_str.rfind("example", find_str.size(), 3) << endl;
