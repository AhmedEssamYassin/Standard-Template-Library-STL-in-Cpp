...
int main()
{
    ...
    cout << "Sorted by first element (Ascending Order):" << endl;
    for (const auto &p : vc)
        cout << p.first << " " << p.second << endl;
    cout << "--------------------------------------------------------" << endl;
    ...
    cout << "Sorted by second element (Ascending Order):" << endl;
    for (const auto &p : vc)
        cout << p.first << " " << p.second << endl;
    cout << "--------------------------------------------------------" << endl;
    ...
    cout << "Sorted by first element (Descending Order):" << endl;
    for (const auto &p : vc)
        cout << p.first << " " << p.second << endl;
    cout << "--------------------------------------------------------" << endl;
    ...
    cout << "Sorted by second element (Descending Order):" << endl;
    for (const auto &p : vc)
        cout << p.first << " " << p.second << endl;
    cout << "--------------------------------------------------------" << endl;
